...
public class RenderTest extends MobRenderer<EntityKyanite, ModelTest<EntityKyanite>> {

    public RenderTest(EntityRendererProvider.Context renderManagerIn, ModelTest<EntityKyanite> baseModel) {
